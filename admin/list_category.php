                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="CategoryTable">
                               ...
                               <?php $i = 1;foreach ($data as $d) { ?>
                                  <tr class="odd gradeX">
                                        ...
                                        <td><a href="edit_category.php?id=<?php echo $d->id ?>" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> Edit</a> <a href="delete_category.php?id=<?php echo $d->id ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure want to delete?')"><i class="fa fa-trash"></i> Delete</a></td>
                                    </tr>
                               <?php } ?>
